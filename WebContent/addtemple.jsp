		...
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<b>Add Worship Places Here...</b>
				</div>

				<div class="panel-body">
					<form class="form-horizontal" action="addTempleServlet" enctype="multipart/form-data" method="post">
						<fieldset>
							...
							<div class="form-group">
								<label class="col-md-3 control-label" for="name">Special Function</label>
								<div class="col-md-6">
									<input id="name" name="sfunction" type="text"
										placeholder="Special Function..." class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<input id="name" name="diwas" type="date" placeholder=""
										class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<select name="type" class="form-control">
										<option>Hindu(Temples)</option>
										<option>Muslim(Mosques)</option>
										<option>Sikh(Churches)</option>
										<option>Isai(Synagogues)</option>
									</select>
								</div>
							</div> 

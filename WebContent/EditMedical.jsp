		...
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<b>UpdateMedical Services Here...</b>
				</div>

				<div class="panel-body">
					<form class="form-horizontal" action="updateMedical"method="post" enctype="multipart/form-data">
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<input id="name" name="address" type="text"value="${list.address}"
										 class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<input id="name" name="distance" type="text" value="${list.distance}"
										class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<input id="name" name="diwas" type="text" value="${list.sthapana}" class="form-control">
								</div>
							</div>
